...
<section>
    <form method="post" action="resume" enctype="application/x-www-form-urlencoded">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <input type="text" name="${type}${counter.index}startDate" size=10
                                               value="<%=DateUtil.format(period.getBeginDate())%>"
                                               placeholder="MM/yyyy">
                                    </dd>
                                </dl>
                                <dl>
                                    ...
                                    <dd>
                                        <input type="text" name="${type}${counter.index}endDate" size=10
                                               value="<%=DateUtil.format(period.getFinishDate())%>"
                                               placeholder="MM/yyyy">
                                </dl>
                                <dl>
                                    <dt>Должность:</dt>
        ...
        <button type="submit">Сохранить</button><!--submit-сохраним и отправим данные на сервер-->
