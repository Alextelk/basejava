...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        expirience.setOrganizationsList(new Organization("www.javaops.ru", "Java Online Project",
                LocalDate.of(2013, 10, 1), LocalDate.now(), "Автор проекта",
                "Создание, организация и проведение Java онлайн проектов и стажировок."));
        expirience.setOrganizationsList(new Organization("www.yota.ru", "Yota",
                LocalDate.of(2008, 6, 1), LocalDate.of(2010, 12, 01),
        ...
        education.setOrganizationsList(new Organization("www.siemens.com", "Siemens AG",
                LocalDate.of(2005, 01, 01), LocalDate.of(2005, 04, 01),
                "Студент", "3 месяца обучения мобильным IN сетям (Берлин)"));
        education.setOrganizationsList(new Organization("www.alcatel.com", "Alcatel",
